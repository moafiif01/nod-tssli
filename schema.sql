...
CREATE UNIQUE INDEX unique_prayer_per_day ON public.prayer_logs (user_id, prayer, ((logged_at AT TIME ZONE 'UTC')::DATE));
...
ON public.prayer_logs FOR SELECT USING (true); -- Needed so the view works for anon
